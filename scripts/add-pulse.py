...
if 'id="market-pulse-top"' not in s:
    ...
    s = s.replace('    </nav>\n\n    <section id="top" class="hero">'.encode('utf-8').decode('unicode_escape'), '    </nav>' + html + '\n\n    <section id="top" class="hero">')
